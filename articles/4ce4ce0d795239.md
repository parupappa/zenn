...
CNCFの[Trail Map](https://github.com/cncf/trailmap)を見てみても、実践的なCloudNativeを目指すには長く険しい道のりが待っており、一息に実現することは、ほとんど現実的ではない。
...
k8s周辺エコシステムやツール群は、日々便利なOSSがアップデートされ続けている。（OSS Insight Kubernetes Tooling - Ranking : https://ossinsight.io/collections/kubernetes-tooling/）
